...
docker exec 4cfd22e7d5bf mkdir -p ${CONTAINER_BACKUP_DIR}

mkdir -p ${PROJECT_BACKUP_DIR}

docker exec 4cfd22e7d5bf pg_dump -U ${USER} ${DATABASE} -F p -f ${CONTAINER_OUTPUT_FILE}

docker cp 4cfd22e7d5bf:${CONTAINER_OUTPUT_FILE} ${HOST_OUTPUT_FILE}
